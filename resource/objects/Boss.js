...
export class Boss2 {
    ...
    draw(c) {
        ...
        c.moveTo(this.x, this.y + this.v_height/2.0);
        c.lineTo(this.x + this.v_width/2.0, this.y + this.v_height);
        c.lineTo(this.x + this.v_width, this.y + this.v_height);
        c.lineTo(this.x + this.v_width/2.0, this.y + this.v_height/2.0);
        c.lineTo(this.x + this.v_width, this.y);
        c.lineTo(this.x + this.v_width/2.0, this.y);
        c.closePath();
    ...
    update(game_mgr) {
        switch(this.mode){
            ...
            case "attack":
                if(this.itr % 100 === 0){
                    game_mgr.manager_addItem("main", new Missle(this.x + this.width/2.0, this.y + this.height, 0, 4, 1, game_mgr.manager_getItem("me"), game_mgr));
                    game_mgr.manager_addItem("main", new Missle(this.x + this.width/2.0, this.y, 0, -4, 1, game_mgr.manager_getItem("me"), game_mgr));
                }
            ...
            case "explosion":
                game_mgr.manager_addItem("bglist", new Smoke(this.x + this.width/2.0, this.y + this.height/2.0, this.width, 10));
                game_mgr.manager_addItem("item", new ItemL(this.x, this.y + this.v_height/2.0, -1.1, 0.5));
                game_mgr.manager_addItem("item", new ItemL(this.x, this.y + this.v_height/2.0, -1.2, 0.4));
                game_mgr.manager_addItem("item", new ItemL(this.x, this.y + this.v_height/2.0, -1.3, 0.3));
                game_mgr.manager_addItem("item", new ItemL(this.x, this.y + this.v_height/2.0, -1.2, 0.2));
                game_mgr.manager_addItem("item", new ItemL(this.x, this.y + this.v_height/2.0, -1.1, 0.1));
                game_mgr.manager_addItem("item", new Item3(this.x, this.y + this.v_height/2.0, -1.0, 0));
                this.alive = false;
...
export class LastBoss {
    ...
    draw(c) {
        ...
        c.beginPath();
        c.save();
        c.translate(this.x + this.v_width/2.0, this.y + this.v_height/2.0);
        c.rotate((Math.PI/180)*this.phase);
        c.translate(-this.x - this.v_width/2.0, -this.y - this.v_height/2.0);
        c.rect(this.x, this.y, this.v_width, this.v_height);

        c.lineWidth = 1;
        c.strokeStyle = "#bb7777";
        c.stroke();
        if(!this.damaged){
            c.fillStyle = "#bb7777";
            c.fill();
        ...
        switch(this.mode){
            ...
            case "attack":
                ...
                if(this.itr < 100 || (this.itr >= 400 && this.itr < 500)){
                    ...
                    if(this.itr % 90 === 0){
                        game_mgr.manager_addItem("main", new Missle(this.x + this.width/2.0, this.y, 0, -6, 1, game_mgr.manager_getItem("me"), game_mgr));
                        game_mgr.manager_addItem("main", new Missle(this.x + this.width/2.0, this.y, 0, -6, 1, game_mgr.manager_getItem("me"), game_mgr));
                        game_mgr.manager_addItem("main", new Missle(this.x, this.y + this.height/2.0, -6, 0, 1, game_mgr.manager_getItem("me"), game_mgr));
                        game_mgr.manager_addItem("main", new Missle(this.x + this.width/2.0, this.y + this.height, 0, 6, 1, game_mgr.manager_getItem("me"), game_mgr));
                        game_mgr.manager_addItem("main", new Missle(this.x + this.width/2.0, this.y + this.height, 0, 6, 1, game_mgr.manager_getItem("me"), game_mgr));
                    }
                }
                ...
                if(this.itr % 16 === 0){
                    game_mgr.manager_addItem("bullet_en", new Bullet_B1(this.x, this.y + this.height/2.0, -10, 0));
                    game_mgr.manager_addItem("bullet_en", new Bullet_B1(this.x, this.y + this.height/2.0, -6, -8));
                    game_mgr.manager_addItem("bullet_en", new Bullet_B1(this.x, this.y + this.height/2.0, -8, -6));
                    game_mgr.manager_addItem("bullet_en", new Bullet_B1(this.x, this.y + this.height/2.0, -6, 8));
                    game_mgr.manager_addItem("bullet_en", new Bullet_B1(this.x, this.y + this.height/2.0, -8, 6));
                }
